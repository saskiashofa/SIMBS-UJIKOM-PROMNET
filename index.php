...
// Fungsi Search
$buku = search_buku($keyword, $awalData, $jumlahDataPerHalaman);
?>
            ...
            >
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item active">
                    <a href="kategori.php" class="nav-link <?= $current_page == 'kategori.php' ? 'active' : '' ?>">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Data Kategori</p>
                    </a>
                  </li>
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <a href="tambah_data.php">
                  <button class="btn-sm btn btn-primary">Tambah Buku</button>
                </a>
              </div>
                ...
                <table class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <img src="dist/assets/img/<?= $row['gambar']; ?>" width="500" class="img-thumbnail">
                            </td>
                            <td><?= date('d-m-Y', strtotime($row['tanggal'])); ?></td>

                            <td>
                                <a href="ubah_data.php?id=<?= $row['id_buku']; ?>" class="btn btn-success btn-sm mb-1">Edit</a>
                                <a href="hapus.php?id=<?= $row['id_buku']; ?>" onclick="return confirm('Yakin ingin hapus?')" class="btn btn-danger btn-sm">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
